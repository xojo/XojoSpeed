...
#tag WindowCode
	...
	#tag Constant, Name = kAboutText, Type = Text, Dynamic = False, Default = \"Xojo Speedometer is made with Xojo\x2C a multi-platform development tool that makes it super-easy to create your own iOS apps.\n\nWant to see how Xojo Speedometer was made\?\n\nUse the buttons below to get the full source code for Xojo Speedometer on GitHub or watch the short iOS QuickStart video on YouTube.", Scope = Private
	#tag EndConstant
